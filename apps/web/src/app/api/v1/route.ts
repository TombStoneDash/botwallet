...
export async function GET() {
  return NextResponse.json({
    ...
    endpoints: {
      ...
      "POST /api/v1/register": "Register an agent, get API key + wallet (agent auth — requires an existing bw_... key)",
      ...
      "POST /api/v1/fund": "Add funds to agent wallet (agent auth)",
